...
//        customers.add(new CommonCustomer(1, "Vanya", 26, "aaaa@gh.dm",new CommonCart()));
//        customers.add(new CommonCustomer(2, "Petya", 30, "bbbb@gh.dm", new CommonCart()));
//        customers.add(new CommonCustomer(3, "Sidor", 40, "cccc@gh.dm", new CommonCart()));
//
...
//                customers.add(new CommonCustomer(++currentCustomerId, parts[5], 4,"fff@bbb", new CommonCart()));
//            }
